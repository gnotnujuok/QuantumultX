...
1️⃣ ⟦𝐬𝐞𝐫𝐯𝐞𝐫 节点⟧ ➠ 参数说明:
⦿ info=1, 开启通知提示机场流量信息;
⦿ emoji=1(国行2)/-1, 添加/删除节点名内地区旗帜;
⦿ udp=1/-1, tfo=1/-1, 分别强制开启/关闭 𝐮𝐝𝐩-𝐫𝐞𝐥𝐚𝐲 和 𝐟𝐚𝐬𝐭-𝐨𝐩𝐞𝐧;
